  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto hero-text">
        ...
        <div className="relative w-full max-w-2xl mx-auto search-input">
          <input
            type="text"
            placeholder="Exploring AI Tool With AI"
            className="w-full h-12 pl-12 pr-4 rounded-full text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-[#2EFFD5] transition-all bg-white/5 backdrop-blur-sm"
          />
          <div className="absolute right-2 top-1/2 transform -translate-y-1/2 w-10 h-10 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center">
            <Search className="text-white" />
          </div>
