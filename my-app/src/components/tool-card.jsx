        ...
        >
          <Link href={`/${category}/${name}`} passHref>
            <div className="relative p-6 pb-1 bg-white/5 backdrop-blur-sm cursor-pointer transition-colors duration-300 ease-in-out hover:bg-white/10">
              ...
              <CardItem translateZ="40" className="text-gray-400 text-lg mb-6 line-clamp-2">
                {tagline}
              </CardItem>

              <CardItem translateZ="30" className="flex flex-wrap gap-2 mb-8">
          ...
          >
            <div className="flex items-stretch">
              <CardItem
                ...
                className="flex items-center justify-center gap-2 px-36 py-5 flex-1 hover:bg-white/10 text-white text-base transition-colors border-r border-white/[0.08] hover:text-primary"
              >
                <span>Visit</span>
              ...
              <CardItem
                translateZ="30"
                as="button"
                className="p-5 hover:bg-white/10 text-white/40 hover:text-primary px-7 transition-colors"
              >
